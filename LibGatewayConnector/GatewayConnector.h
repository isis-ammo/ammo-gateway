  ...
  namespace gateway {
    ...
    */
    ...
    private:
      ...
      void onConnect(ACE_Connector<ammo::gateway::internal::GatewayServiceHandler, ACE_SOCK_Connector> *connector, ammo::gateway::internal::GatewayServiceHandler *handler);
      void onDisconnect();
      ...
      friend class ammo::gateway::internal::GatewayConnectionManager;
    };
