...
public:
  ...
  bool pullResponseCrossGateway(std::string requestUid, std::string pluginId, std::string mimeType, std::string uid, std::string encoding, const std::string &data, std::string originHandlerId, char priority);
