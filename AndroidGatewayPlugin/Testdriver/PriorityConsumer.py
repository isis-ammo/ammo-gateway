...
def onDataReceived(connector, msg):
  ...
  if msg.type == AmmoMessages_pb2.MessageWrapper.DATA_MESSAGE:
    ...
    expectedPriority = int(splitMessage[2])
    sentPriority = msg.message_priority
    
    print "{0},{1:.9f},{2},{3}".format(sequenceNumber, timeDifference, expectedPriority, sentPriority)
