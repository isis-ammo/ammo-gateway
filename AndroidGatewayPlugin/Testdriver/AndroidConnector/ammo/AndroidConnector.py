...
class AndroidConnector(threading.Thread):
  ...
  def push(self, uid, mimeType, data, scope = MessageScope.GLOBAL, priority = MessagePriority.NORMAL, ackDeviceDelivered = False, ackPluginDelivered = False, ackAndroidPluginReceived = True):
    '''
