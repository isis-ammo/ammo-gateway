...
if __name__ == "__main__":
  ...
  try:
    ...
    while True:
      ...
      connector.push("item:" + str(sequenceNumber), "ammo/edu.vu.isis.ammo.test.TestData", str(sequenceNumber) + "/" + formattedTime + "/" + str(priority) + "/" + os.urandom(options.size), scope, priority)
      print "Pushed sequence number", sequenceNumber, "at", "{0:.6f}".format(time.time()), "priority", priority
