...
if __name__ == "__main__":
  ...
  try:
    ...
    while True:
      ...
      connector.push("item:" + str(sequenceNumber), "ammo/edu.vu.isis.ammo.test.TestData", str(sequenceNumber) + "/" + formattedTime + "/" + os.urandom(options.size), scope, ackDeviceDelivered = True, ackPluginDelivered = True, ackAndroidPluginReceived = False)
