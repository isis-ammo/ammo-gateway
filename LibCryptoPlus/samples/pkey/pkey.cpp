...
//		cryptoplus::pkey::rsa_key rsa_key = cryptoplus::pkey::rsa_key::generate_private_key(1024, NULL, 0, NULL, NULL);
		cryptoplus::pkey::rsa_key rsa_key = cryptoplus::pkey::rsa_key::generate_private_key(1024, 3, NULL, NULL);

		std::cout << "Done." << std::endl;

		cryptoplus::pkey::pkey pkey = cryptoplus::pkey::pkey::from_rsa_key(rsa_key);
